...
namespace cis237inclass6.Controllers
{
    ...
    {
        private CarsNSmithEntities db = new CarsNSmithEntities();
        ...
        public ActionResult Index()
        {
            ...
            //IF there is nothing in the session we can still use these variable
            //as a default value.
            string filterMake = "";
            string filterMin = "";
            string filterMax = "";
        ...
        //reuquests it will handle to only POST. We can also specify
